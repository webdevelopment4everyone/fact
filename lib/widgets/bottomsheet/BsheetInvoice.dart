...
class BshhetInvoice extends StatefulWidget {
  const BshhetInvoice({super.key});

  @override
  State<BshhetInvoice> createState() => _BshhetInvoiceState();
}

class _BshhetInvoiceState extends State<BshhetInvoice> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FormUI(countcontroller2, 'Quantity', 'Quantity', null,
                      false),
                  FormUI(countcontroller3, 'Selling Price', 'Selling Price', null, false),
                  FormUI(countcontroller4, 'Total',
                      'Total', null, false),
                  FormUI(countcontroller5, 'Net Price', 'Net Price', null, false),
                  SizedBox(
  ...
  void makeadd() {
    ...
    String sellingPrice = countcontroller3.text;
    String total = countcontroller4.text;
    String netPrice = countcontroller5.text;

    print(countcontroller.text);

    Provider.of<InvoiceFormModelProvider>(context,
            listen: false)
        .createPeriodicPartsTask(InvoiceFormModel(
            serialNo,
            itemName,
            quantity,
            sellingPrice,
