...
PeriodicMaintenanceRequest periodicMaintenanceRequestFromJson(String str) =>
    PeriodicMaintenanceRequest.fromJson(json.decode(str));
String periodicMaintenanceRequestToJson(PeriodicMaintenanceRequest data) =>
    json.encode(data.toJson());

class PeriodicMaintenanceRequest {
  ...
  PeriodicMaintenanceRequest.fromJson(dynamic json) {
  ...
  String? _ticketType;
  PeriodicMaintenanceRequest copyWith({
    String? srEquipModel,
    String? equipmentId,
    String? manualEquSer,
    String? kilometerReading,
