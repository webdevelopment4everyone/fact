...
BreakDownRequest breakDownRequestFromJson(String str) =>
    BreakDownRequest.fromJson(json.decode(str));
String breakDownRequestToJson(BreakDownRequest data) =>
...
class BreakDownRequest {
  ...
  BreakDownRequest.fromJson(dynamic json) {
