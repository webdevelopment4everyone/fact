...
GeneralTicketResponse generalTicketResponseFromJson(String str) =>
    GeneralTicketResponse.fromJson(json.decode(str));
String generalTicketResponseToJson(GeneralTicketResponse data) =>
    json.encode(data.toJson());

class GeneralTicketResponse {
  ...
  GeneralTicketResponse.fromJson(dynamic json) {
  ...
  GeneralTicketResponse copyWith({
    int? statuscode,
    Data? data,
    String? statusMessage,
  }) =>
