...
PreventiveMaintainceServiceReport preventiveMaintainceServiceReportFromJson(
        String str) =>
    PreventiveMaintainceServiceReport.fromJson(json.decode(str));
String preventiveMaintainceServiceReportToJson(
        PreventiveMaintainceServiceReport data) =>
    json.encode(data.toJson());

class PreventiveMaintainceServiceReport {
  PreventiveMaintainceServiceReport({
  ...
  PreventiveMaintainceServiceReport.fromJson(dynamic json) {
  ...
  set genchkbrkoiltem(String? value) {
    _genchkbrkoiltem = value;
  }
}
