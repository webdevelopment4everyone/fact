...
SubassemblyServicereportModel subassemblyServicereportModelFromJson(
        String str) =>
    SubassemblyServicereportModel.fromJson(json.decode(str));
String subassemblyServicereportModelToJson(
        SubassemblyServicereportModel data) =>
    json.encode(data.toJson());

class SubassemblyServicereportModel {
  SubassemblyServicereportModel({
  ...
  SubassemblyServicereportModel.fromJson(dynamic json) {
